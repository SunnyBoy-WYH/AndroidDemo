...
public class DBOpenHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String sql_p4 = "insert into student(id ,name ,sex,age ,banji , phone, college )" +
                    " values(20171302031,'霍丙南','男',20,'17材料2班',18812141604,'化学与环境科学学院')";
            String sql_p5 = "insert into student(id ,name ,sex,age ,banji , phone, college )" +
                    " values(20171102027,'王昭淞','男',20,'17材料2班',18812141604,'化学与环境科学学院')";
            ...
            db.execSQL("insert into student_course values(20171302030,'运筹学','司建辉',79)");
            db.execSQL("insert into student_course values(20171302028,'运筹学','司建辉',90)");
            db.execSQL("insert into student_course values(20180301178,'运筹学','司建辉',85)");
            db.execSQL("insert into student_course values(20171302029,'运筹学','司建辉',90)");
            db.execSQL("insert into student_course values(20171302031,'运筹学','司建辉',60)");
            db.execSQL("insert into student_course values(20171102028,'运筹学','司建辉',98)");
            db.execSQL("insert into student_course values(20171102030,'运筹学','司建辉',90)");
            db.execSQL("insert into student_course values(20171102027,'运筹学','司建辉',75)");

            db.execSQL("insert into student_course values(20171302030,'数学模型','司建辉',79)");
            db.execSQL("insert into student_course values(20171302028,'数学模型','司建辉',90)");
            db.execSQL("insert into student_course values(20180301178,'数学模型','司建辉',85)");
            db.execSQL("insert into student_course values(20171302029,'数学模型','司建辉',90)");
            db.execSQL("insert into student_course values(20171302031,'数学模型','司建辉',60)");
            db.execSQL("insert into student_course values(20171102028,'数学模型','司建辉',98)");
            db.execSQL("insert into student_course values(20171102030,'数学模型','司建辉',90)");
            db.execSQL("insert into student_course values(20171102027,'数学模型','司建辉',75)");
