...
public class student_choose_course_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //绑定textview组件
        TextView textView_tip = findViewById(R.id.text_tongji);

        //button绑定
        Button button_banji = findViewById(R.id.button_groupby_banji);
        Button button_score = findViewById(R.id.orderby_score);
        Button button_aver = findViewById(R.id.button_average_score);
        Button button_name = findViewById(R.id.orderby_name);
